...
pub(super) fn check_prerequisites(study: &crate::study::Study) -> Result<(), super::RuntimeError> {
    ...
    for interpreter in interpreters {
        let probe = "import sys; assert sys.version_info >= (3,14), 'Python 3.14+ required'; import scientific_workflow, numpy, threadpoolctl; assert scientific_workflow.__version__ == '0.5.0', 'install scientific-workflow[npy] 0.5.0'; from scientific_workflow.npy import convert_workflow_dependencies";
