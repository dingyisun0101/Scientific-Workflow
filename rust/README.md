...
Start with the [beginner getting-started guide](https://github.com/dingyisun0101/Scientific-Workflow/blob/v0.13.11/rust/getting-started.md). It
...
adds `#[derive(Deserialize)]`; the [getting-started guide](https://github.com/dingyisun0101/Scientific-Workflow/blob/v0.13.11/rust/getting-started.md#why-serde-and-deserialize-appear)
...
- implementing a custom persistence backend, writer lifecycle, or incompatible
  ...
  [recording v7 protocol](https://github.com/dingyisun0101/Scientific-Workflow/blob/v0.13.11/protocol/recording-v7.md));
...
[`architecture.md`](https://github.com/dingyisun0101/Scientific-Workflow/blob/v0.13.11/docs/architecture.md).
