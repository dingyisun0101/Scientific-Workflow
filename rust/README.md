...
> [migration guide](https://github.com/dingyisun0101/Scientific-Workflow/blob/v0.15.2/docs/migration-0.15.0.md) before upgrading.

## Describe your study. Let AI configure it.

> **All AI agents must read [docs/AGENTS.md](https://github.com/dingyisun0101/Scientific-Workflow/blob/v0.15.2/docs/AGENTS.md) before working
...
[AI-assisted studies guide](https://github.com/dingyisun0101/Scientific-Workflow/blob/v0.15.2/docs/guide/12-ai-assisted-studies.md) shows how
to set up reusable components so later experiments can stay in configuration.

![Scientific Workflow dashboard showing task progress, allocated threads, live messages, and resource usage](https://raw.githubusercontent.com/dingyisun0101/Scientific-Workflow/v0.15.2/docs/assets/UI-3.png)
...
- **[Start the numbered guide](https://github.com/dingyisun0101/Scientific-Workflow/blob/v0.15.2/docs/guide/1-overview.md)** — from setup to
  a working model, parameter sweeps, and analysis.
- **[Build your first study](https://github.com/dingyisun0101/Scientific-Workflow/blob/v0.15.2/docs/guide/3-first-study.md)** — every file,
  the run command, and a verified result.
- **[Browse worked examples](https://github.com/dingyisun0101/Scientific-Workflow/blob/v0.15.2/docs/examples.md)** — complete scientific pipelines.
- **[Documentation index](https://github.com/dingyisun0101/Scientific-Workflow/blob/v0.15.2/docs/README.md)** ·
  **[Rust API](https://docs.rs/scientific-workflow/0.15.2/scientific_workflow/)** ·
  **[Python API](https://github.com/dingyisun0101/Scientific-Workflow/blob/v0.15.2/python/src/scientific_workflow/api.md)**.
...
0.5.0. See [installation](https://github.com/dingyisun0101/Scientific-Workflow/blob/v0.15.2/docs/guide/2-installation.md).
...
[disk guard behavior](https://github.com/dingyisun0101/Scientific-Workflow/blob/v0.15.2/docs/guide/10-running-and-monitoring.md#disk-guard-and-npy-resource-policy) for process handling
...
[phase and execution-unit selection](https://github.com/dingyisun0101/Scientific-Workflow/blob/v0.15.2/docs/guide/11-reusing-results.md#optional-phase-and-execution-unit-selection)
...
See the [Config reference](https://github.com/dingyisun0101/Scientific-Workflow/blob/v0.15.2/rust/src/config/api.md) for full path validation rules.
...
Worked scientific definitions are documented in the [project configuration guide](https://github.com/dingyisun0101/Scientific-Workflow/blob/v0.15.2/docs/guide/4-project-configuration.md)
and [Config grammar](https://github.com/dingyisun0101/Scientific-Workflow/blob/v0.15.2/rust/src/config/api.md): `seed`, `paths.states`, phase `after`
...
Licensed under [MIT](https://github.com/dingyisun0101/Scientific-Workflow/blob/v0.15.2/rust/LICENSE).
