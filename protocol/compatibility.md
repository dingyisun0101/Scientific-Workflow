...
| --- | ---: | ---: | ---: |
| Rust `scientific-workflow` | 0.13.3 | v7 | v7 |
...
Rust 0.13.3 accepts project configuration `workflow_schema: 1`. That authored
configuration generation is separate from recording format v7: changing one
does not implicitly change the other.

This matrix was reviewed for Rust 0.13.3 with Python reader 0.4.2. Recording
