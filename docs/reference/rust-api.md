...
This overview groups ordinary and advanced APIs. For the learning path, start at
[the numbered guide](../README.md). The subsystem `api.md` files remain the
authoritative exhaustive contracts.
...
roots.
The tables below summarize common public symbols and operations. Consult the
linked subsystem contracts for the complete supported surface.
...
See [`src/state/api.md`](../../rust/src/state/api.md),
[`src/observation/api.md`](../../rust/src/observation/api.md),
[`src/task/api.md`](../../rust/src/task/api.md),
[`src/config/api.md`](../../rust/src/config/api.md),
[`src/study/api.md`](../../rust/src/study/api.md),
[`src/persistence/api.md`](../../rust/src/persistence/api.md),
[`src/runtime/api.md`](../../rust/src/runtime/api.md),
...
[`architecture.md`](https://github.com/dingyisun0101/Scientific-Workflow/blob/v0.15.1/docs/architecture.md).
